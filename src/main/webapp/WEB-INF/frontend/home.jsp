...
<html lang="en">
<head>
    <jsp:include page="/WEB-INF/frontend/common/head.jsp"/>
</head><!--/head-->
<body>
<jsp:include page="/WEB-INF/frontend/common/header.jsp"/>
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <img src="/api/product-image/${product.image}" alt="" />
                                        <h2>$${product.price}</h2>
                                        <p>${product.name}</p>
                                    ...
                                    <div class="product-overlay">
                                        <div class="overlay-content">
                                            <h2>$${product.price}</h2>
                                            <p>${product.name}</p>
                                            <a href="/cart?product=${product.id}&user=<sec:authentication property="principal.id"" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<jsp:include page="/WEB-INF/frontend/common/foot.jsp"/>
</body>
</html>
