        ...
        <div class="col-sm-8 mx-auto">
            ...
            <form class="row g-3 needs-validation" novalidate action="/backend/product/save" method="post">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="image" value="${product.image}" hidden class="form-control" id="fileUploadName" required>
                    <div class="invalid-feedback">
                        Vui lòng chọn file.
                    </div>
                </div>
                <div class="col-md-6">
                    <img id="outputImage" src="/api/product-image/${product.image}" width="100px"/>
                </div>
                <div class="col-12">
